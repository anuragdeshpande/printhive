export default {
  ...
  nav: {
    ...
    installAppSuccess: 'PrintHive was installed',
    more: 'More',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'When on, this printer is paused from MQTT, queue dispatch and notifications — useful for repair, parallel PrintHive installs, or temporary suspension.',
    },
    // Chamber light
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'The slicer didn\'t leave the .gcode.3mf on the printer\'s SD card, so PrintHive couldn\'t pull the thumbnail or slicer metadata. This is usually because "Store sent files on external storage" is off in the slicer (Bambu Studio / OrcaSlicer Device tab).',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'LDAP groups are mapped to PrintHive groups on login',
      ...
      autoProvisionHint: 'Automatically create a PrintHive account on first LDAP login',
      ...
      groupMappingHint: 'Map LDAP group DNs to PrintHive groups. Available groups: ',
    ...
    localLogin: {
      ...
      disableHint: 'When enabled, only SSO providers can sign in. LDAP is unaffected. Set PRINTHIVE_LOCAL_LOGIN=true on the server to keep a recovery path.',
    },
    // Queue
    ...
    preheatFilamentTargetsHint: 'PrintHive picks the highest target across the loaded AMS slots. A print whose slots all derive 0 — PLA, PETG, TPU, PVA — skips preheat entirely and starts immediately.',
    ...
    authDisabledMessage: 'Enable authentication to create user accounts, manage permissions, and secure your PrintHive instance.',
    ...
    disableAuthenticationMessage: 'Are you sure you want to disable authentication? This will make your PrintHive instance accessible without login. All users will remain in the database but authentication will be disabled.',
    disableAuthentication: 'Disable Authentication',
    // Additional settings
    configureBambuddy: 'Configure PrintHive',
    ...
    captureFinishPhotoDescription: 'Take a photo from printer camera when print completes. PrintHive records a brief timelapse during the print so the photo can be sourced from the moment before the bed drops; the timelapse file is kept if you enabled timelapse for this print, otherwise it is deleted automatically after the photo is captured.',
    finishPhotoRestorePlate: 'Restore plate for finish photo',
    finishPhotoRestorePlateDescription: 'The printer drops the build plate about 100 mm when a print ends, leaving the finished print below the camera\'s framing. PrintHive raises it back to just above the last printed layer, takes the photo, then lowers it again. Skipped when the print height is unknown or another job is queued.',
    ...
    bambuddySoftware: 'PrintHive Software',
    ...
    updateViaHomeAssistant: 'Updates are managed by the Home Assistant Supervisor. Open Settings → Add-ons → PrintHive in Home Assistant to install the new version.',
    ...
    externalUrlDescription: 'The external URL where PrintHive is accessible. Used for notification images and external integrations.',
    bambuddyUrl: 'PrintHive URL',
    ...
    mqttDescription: 'Publish PrintHive events to an external MQTT broker for integration with Node-RED, Home Assistant, and other automation systems.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP secrets and OIDC client_secrets are stored in plaintext. Set MFA_ENCRYPTION_KEY or restart PrintHive with a writable data directory to auto-generate one.',
      ...
      migrationErrorWarning: '{{count}} legacy row(s) failed to re-encrypt at startup. Check server logs and restart PrintHive to retry.',
    },
  ...
  login: {
    ...
    resetStep1: 'Contact your PrintHive administrator',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Open your authenticator app and enter the 6-digit code for PrintHive.',
  ...
  // Setup page
  setup: {
    title: 'PrintHive Setup',
    subtitle: 'Configure authentication for your PrintHive instance',
  ...
  users: {
    ...
    subtitle: 'Manage users and their access to your PrintHive instance',
    backToSettings: 'Back to Settings',
    createUser: 'Create User',
    noPermission: 'You do not have permission to access this page.',
    admin: 'Admin',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Sign in to your Orca Cloud account to sync your slicer profiles into PrintHive.',
      },
      device: {
  ...
  sponsors: {
    ...
    tagline: 'PrintHive is free and stays that way because people choose to support it. No VC, no cloud lock-in.',
    viewSupporters: 'View supporters',
    toastPrints: "You've completed {{count}} prints with PrintHive. PrintHive stays free thanks to its supporters.",
    toastCost: "You've tracked {{total}} in filament with PrintHive. See who keeps the project independent.",
    toastArchives: '{{count}} prints archived with PrintHive. See who keeps it independent.',
    toastAnniversary: 'One year with PrintHive! See who keeps the project independent.',
    toastVersionUpdate: 'Updated to v{{version}}. PrintHive stays free thanks to its supporters.',
    toastBusiness: "Running PrintHive on {{count}} printers? There's a support plan for teams — priority fixes, invoicing, and a direct line to the maintainer.",
    businessCta: 'PrintHive for business',
    businessTitle: 'PrintHive for business',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'PrintHive is served over HTTPS (via your reverse proxy), but your Spoolman URL is still plain HTTP. Browsers block mixed content for security, so the embedded Spoolman UI can\'t render. Spoolman needs to be reachable over HTTPS for this to work.',
    spoolmanMixedContentFixReverseProxy: 'Put Spoolman behind the same reverse proxy as PrintHive (Traefik / Nginx / Caddy) with HTTPS, then update the Spoolman URL in Settings to the new HTTPS address.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Repository is PUBLIC. PrintHive backups include MQTT credentials, Home Assistant tokens, Prometheus tokens, your Bambu Cloud email, and printer access codes via K-profiles. Saving is blocked until you make the repository private in your provider\'s settings.',
    repoVisibilityUnknown: 'Could not determine repository visibility. PrintHive refuses to back up to anything not confirmed private; saving will be blocked.',
    ...
    appSettingsDescription: 'PrintHive configuration (complete database)',
    ...
    localBackupDescription: 'Create a complete backup of your PrintHive data including the database, archives, uploads, and all files.',
    ...
    backupRestoredRestart: 'Backup restored. Please restart PrintHive.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Notes are saved in PrintHive, not on the printer',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visible as "PrintHive" in slicer discovery',
    ...
    remoteInterface: {
      ...
      hint: 'Override the IP address advertised via SSDP and used in the TLS certificate. Useful when PrintHive has multiple network interfaces.',
    },
    mode: {
      title: 'Mode',
      archive: 'Archive',
    ...
    caCert: {
      ...
      description: 'Virtual printers use a TLS certificate signed by the PrintHive CA. Import this CA certificate into your slicer\'s trust store once so it accepts the connection — no need to copy it from the command line.',
      copy: 'Copy',
      copied: 'Copied',
      download: 'Download',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: 'In Archive, Review, and Queue modes, use the "Send" button in your slicer to upload 3MF files to PrintHive. The slicer will show "Print success" — the file is stored, not printed.',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'PrintHive Backend URL',
      apiToken: 'API Token',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'The option is on and storage is present, but the last print still went to the printer\'s internal storage, which Bambuddy cannot read. On H2-series, P2S and X2D, Bambu Studio\'s Print button always sends there whatever this option is set to. Prints archive with their name and timing, but without a thumbnail or slicer metadata. For complete archives, start prints from Bambuddy or slice in OrcaSlicer — or in Bambu Studio use Send with External selected, then start the print.',
      ...
      network_mode: {
        ...
        warn: 'PrintHive is running in {{runtime}} with bridge networking. Printer discovery and the Virtual Printer need host networking — recreate the container with host network mode ("network_mode: host" in docker-compose, "--network=host" for Podman).',
        skip: 'Not running in a container — not applicable.',
        skip_unknown: 'PrintHive is running in {{runtime}}, but its network mode could not be determined. If printer discovery or the Virtual Printer do not work, recreate the container with host networking.',
        skip_system_container: 'PrintHive is running in a {{runtime}} system container, which sits on the LAN like a virtual machine — not applicable.',
      },
      subnet: {
        title: 'Network subnet',
        pass: 'The printer and PrintHive are on the same subnet.',
        warn: 'The printer ({{printer_ip}}) and PrintHive ({{host_ip}}) are on different subnets. They may not reach each other unless routing between the subnets is configured.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Re-copy the access code from the printer screen (LAN settings) and update it in the printer\'s settings in PrintHive.',
      },
      'ftp-connection-timeout': {
        name: 'File-transfer connection timed out',
        cause: 'PrintHive could not reach the printer\'s file-transfer port (FTPS 990). The port is blocked, or the printer is off or on another subnet.',
        fix: 'Make sure nothing blocks port 990 between PrintHive and the printer, and that both are on the same network.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Switch PrintHive to an external PostgreSQL database. See the PostgreSQL guide in the documentation.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'The virtual printer is enabled but its services are not running. Check the PrintHive log — a bind IP conflict or a permission error usually stops them.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificate ready. Make sure the PrintHive CA certificate (above) is imported into your slicer\'s trust store.',
        fail: 'The TLS certificate for this virtual printer is missing. Check that the PrintHive data directory is writable.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'The ML API fetches the camera snapshot by URL. Set the External URL in General settings so the ML API container can reach PrintHive.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Paste a MakerWorld model URL to import and print it directly from PrintHive — without leaving for the Bambu Handy app.',
    ...
    disclaimer: 'MakerWorld integration uses community-documented API endpoints. PrintHive is not affiliated with or endorsed by MakerWorld or Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Files in external (linked) folders are skipped — PrintHive never deletes bytes it does not own.',
