export default {
  ...
  settings: {
    ...
    preheatFilamentTargetsHint: 'PrintHive picks the highest target across the loaded AMS slots; PLA-only prints derive 0 and skip the chamber phase automatically.',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'PrintHive is running in Docker bridge networking. Printer discovery and the Virtual Printer need host network mode — recreate the container with "network_mode: host".',
