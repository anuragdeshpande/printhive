...
export function SpoolFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full sm:max-w-5xl sm:mx-4 bg-bambu-dark-secondary border-t sm:border border-bambu-dark-tertiary rounded-t-2xl sm:rounded-xl shadow-2xl max-h-[92vh] sm:max-h-[90vh] flex flex-col animate-slide-up sm:animate-none pb-safe">
        {/* Mobile drag handle */}
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 p-4 border-t border-bambu-dark-tertiary flex-shrink-0 bg-bambu-dark-secondary">
          {isEditing && (
            <div className="flex gap-2 max-sm:w-full max-sm:order-2 mr-auto">
